...
func (client *ResourceClient) Action(ctx context.Context, resourceID string, action string, apiVersion string, method string, header *http.Header, body interface{}) (interface{}, error) {
	resp, err := client.action(ctx, resourceID, action, apiVersion, method, header, body)
	if err != nil {
		return nil, err
	}
	var responseBody interface{}
...
func (client *ResourceClient) action(ctx context.Context, resourceID string, action string, apiVersion string, method string, header *http.Header, body interface{}) (*http.Response, error) {
	req, err := client.actionCreateRequest(ctx, resourceID, action, apiVersion, method, header, body)
	if err != nil {
		return nil, err
	}
	resp, err := client.pl.Do(req)
...
func (client *ResourceClient) actionCreateRequest(ctx context.Context, resourceID string, action string, apiVersion string, method string, header *http.Header, body interface{}) (*policy.Request, error) {
	urlPath := resourceID
	if action != "" {
